...
if (isServer) then {
	...
	[west, "UOTCBLUFOR", "player"] call FNC_AddTeam; //Adds a player team called USMC on side west
	[east, "UOTCOPFOR", "ai"] call FNC_AddTeam; //Adds a ai team called VDV on side east

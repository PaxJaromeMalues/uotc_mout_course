...
switch (side player) do {
    ...
    case west:
    {
		...
		<br/>Charlie Company (as per unit organization) at 08202 00457.
		<br/>C´1 at 05875 02149 preparing to secure sector Bat.
		<br/>C´2 at 07142 01920 preparing to secure sector Ball. (YOU)
		<br/>C´3 at 08599 03096 preparing to secure sector Base.
		<br/>D COY has given 3 squads with heavy weapons, one to each Rifle Company.
		<br/> 
		...
		<br/>None as required with the main assault in Bravo Company sectrors.
		<br/> 
		...
		<br/>Alpha Company east of Charlie Company.
		<br/>Bravo Company west of Charlie Company.
		<br/>
		ENDTAB;
		...
		<br/>Charlie Company (together with Alpha and Bravo Company) has been inserted across the border of Pakistan into the highly rural areas of FATA with the task to establish a foothold and stop the advance of jihadist groups towards afghan border area.
		<br/>The UN cleared multiple nations ISAF forces for immediate intervention by mandates due to official pakistani emergency request. ISAF forces can not allow the jihadist groups which are part of the Ittiḥad al-Jihad al-Islāmī to close with the afghan border as this would drastically weaken ISAF force balance in all border regions.
		<br/>AT 0314Z local time first troops of Bravo Company landed in the south area of FATA region. Fleeing Civilians reported mass executions if local populous. Most if not all civilians fled or are dead.
		<br/>
		...
		<br/>Currently there have not been established any areas of immediate interest.
		<br/>
		...
		<br/><img image='res\sat.jpg' width='350' />
		<br/>
		...
		<br/>First light: 04:02:00
		<br/>Last Light: 19:49:21
		<br/>Time Now: 03:45:00
		<br/>
		...
		<br/>Clear visibility with view to the horizon. Limited by low light conditions.
		<br/>
		...
		//If you reference new Intel on qanother point in the OPORD that is not already mentioned in Disposition or Composition, you made a mistake.
		//Explain all Intel in greatest detail. This is of crucial importance.
		<br/>Current Intel assumes the majority of the enemy force in the City of Tottah. Radio reports from local IDAP forces made clear that the insurgents did not hesistate to kill anyone willing to join them. This goes against sofar aquired counter insurgency experience in which the populous was suppressed but not exterminated.
		<br/>The Towns of Bazah Tamir, Goram, Sukri Farem, Hama, Mussara, Khassadar, Sirak and South Sirak, Razzale as well as Goram, Urugal and Paktika Valley areas are considered occupied and fortified by the enemy. Reconnaissance is still under way and not expected in before tomorrow.
		<br/>
		...
		<br/>The insurgent unit comprises out of an unknown amount and type of motorized vehicles two company minus sized infantry elements of mediocre skill armed with eastern block weaponry like AK47s, AKMs, RPG-7s, PKMs and RPKs. From previous engagements and reports we expect them to be Pickup-Mounted MGs, Trucks and other improvised combat vehicles with low to no armour. Though there being no hard recon on this.
		<br/>The enemy had roughly one week time to prepare his positions, expect the enemy to defend himself with all means available.
		<br/>
		...
		<br/>The current layout of the enemy units at FATA region is likely to change as follow on Ittiḥad al-Jihad al-Islāmī loyal forces are moving into our direction.
		<br/>If reinforcements arrive, we expect forces of around another degraded company element.
		<br/>
		...
		<br/>The enemy has access to trucks, cars and motorbikes for the purpose of relocation. All available armed assets are expected to be used against out assault.
		<br/>
		...
		<br/>Near hills might be used by enemy heavy MGs to prevent friendlies from pushing further once they entered the three dominant valleys.
		<br/>
		...
		<br/>The enemy has access and is expected to use all available means of transportation.
		<br/>
		<br/><font size='14'>e. AIR DEFENSE:</font>
		<br/>Sofar none is known, but Manpads in small quantity are expected.
		<br/>
		<br/><font size='14'>f. COMBAT SERVICE SUPPORT:</font>
		<br/>Civilians reported large ammounts of trrucks loaded to the brim with supplies.
		<br/>
		...
		<br/>Enemy Forces have dug in and heavily fortified FATA region over the past week.
		<br/>When faced with overwhelming force the insurgents are likely to abandon unvaluable positions, surrender or go for a fighting retreat.
		<br/>
		...
		<br/>Enemy forces will go into a fighting retreat and have prepared a counter attack or enemy forces will be using civilians and IDAP units as living shields.
		<br/>In second case Charlie Company has orders to take all action including a fighting retreat to safeguard the victims until special operation forces take care of the hostage situation.
		<br/>
		...
		<br/>Battalion HQ has issued these operations in FATA to stop insurgents flooding towards afghan borders following a governmental collapse in Pakistan.
		<br/>
		<br/><font size='14'>b. HIGHER HQ MISSION CONCEPT:</font>
		<br/>Battalion HQs aim is to use Alpha, Bravo and Charlie Company including attachments to secure a 11 Km foothold region through FATAs center area.
		<br/> 
		...
		<br/>Alpha Company will Secure the eastern foothold.
		<br/>Bravo Company will lead the main assault with all available support towards Tottah to take the city by force.
		...
		<br/>Charlie 2nd Platoon and Attached Forces are to establish a blocking position along the new FLOTs LOA border of sector Ball NLT 0615 local time.
		<br/>
		...
		<br/>- Establish safety parameter and prepare to move into Urugal Valley.
		<br/>
		<br/><font color='#d21111' size='15'>LOD C´2</font>
		<br/>- All units are to be in position at LOD to begin assault NLT 0400.
		<br/>- All units are expected to remain weapons silent until 0405, replacement south wards to avoid early contact is expected.
		<br/>- C´2 Platoon Leader is expected to commence operation at 0405 with the first light of day.
		<br/>
		<br/><font color='#d21111' size='15'>Secure Sector Ball</font>
		<br/>- Eleminate or push back all force in sector Ball.
		ENDTAB;
		...
		<br/>- Seize Goram, South Tamir, Razzale and all three valley areas.
		<br/>- Form Blocking Positions at new FLOT.
		<br/>- Prevent insurgent attacks onto friendly ISAF forces at afghan borders.
		<br/>- Prevent insurgents from gaining terrotorial control over FATA region.
		<br/>
		...
		<br/>- C´1 will seize Goram in a cooperative effort with adjacent forces of B´2 NLT 0600 local time and place their squads in support of C´2s and B´2s efforts at Kotar and Goram. As per seperat OPORD.
		<br/>- C´2 will secure Urugal Valley and South Tamir villages with defined orders as per this OPORD Paragraph II. C´2 will avoid roads leading to Al Qalat.
		<br/>- C´3 will secure Paktita Valley and move into blocking position at the new FLOT as per separate OPORD.
		<br/>The decisive point of this mission is to secure all three rural valley areas and push the enemy back across the Tamir riverbed.
		<br/>This is decisive as it is mandatory to hold this position to hinder the enemy from gaining terrootorial advantage over ISAF forces in Afghanistan.
		<br/>Charlie 1 and 2 Platoon will be the main effort of this operation. With 3 Platoon in supporting efforts.
		<br/>Engineers will later disarm all detected IEDs as a separate operation.
		<br/>End state is a straight blocking position along our LOAs consisting out of C´1 at Goram and Kotar, C´2 in South Tamir and C´3 east of Razzale.
		<br/>
		...
		<br/>It is not to be expected to come across any meaningful intel; intel discovered is to be secured after the missions main efforts are accomplished.
		<br/>
		...
		<br/>Engineers will later on clear the area of any remaining explosives.
		<br/>
		...
		<br/>3. Primary and alternate routes per element. C´2 - via the east approach taking high ground from the enemy, alternate route is the center high approach.
		<br/>4. Location of departure and friendly reentry lines. LOD is 200m north of the landing site, FRL are south about 1KM from the landing site.
		<br/>5. ORP C´2 at 75m north of landing site. Surrounded by foliage on a serpent road.
		...
		<br/>8. Reorganization and consolidation instructions. If the unit breaks apart, all units reconsolidate at the last Phase CCP in defensive positions.
		...
		<br/>Limit sectors of fire to sector Ball.
		...
		<br/>Resupply is unavailable for the next 4 hours.
		<br/>Company AXP (Ambulance Exchange Point) is located with C COY HQ.
		<br/>C´2 trauma specialist is to record all casualties for later medevac once available.
		<br/>
		...
		<br/>Many areas of the country are poor and were unable to leave the scene of war. Expect refugees at any time.
		<br/>
		ENDTAB;

		NEWTAB("V. Command & Signal:")
		<br/>During all phases of Company operation the HQ will remain at 08202 00457 with all C2 control elements.
		<br/>
		...
		<br/>Battalion HQ is located with C COY HQ.
		...
		<br/>Charlie COY HQ maintains position throughout all phases.
		<br/><font color='#d21111' size='15'>3. Succession of Command (COY)</font>
		<br/>C´6, C´7, C´1, C´2, C´3, D´2
		...
		<br/>red angle = enemy received heavy reenforcements at sector Ball
		...
		<br/>Red/Orange Flare = enemy position (applied towards enemy units)
		<br/>White Smoke = concealment 
		<br/>Green Flare = friendly position (applied towards friendly units)
		<br/>Yellow Flare = Urgent Medical (applied towards friendly units)
		<br/>Blue Flare = Broken Comms/COC (applied towards friendly units)
		<br/>
		...
		<br/>- Ace Medical Surgical Kit can be used everywhere, as long as the patient is stable. (no bleeding)
		...
		<br/> PaxJaromeMalues, with help of Blackhawk, Perfk, Blue and others. Thanks to you guys!
		<br/>
		ENDTAB;
